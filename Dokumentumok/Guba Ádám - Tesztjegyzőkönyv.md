...
|Bejelentkezés (email) |2023.11.13|A program ellenőrizze, hogy szerepel-e az email cím adatbázisban, ha nem hiba üzenetet dobjon. |A program megkeresi az adatbázisban az email címet, ha nem szerepel hibabüzenetet dob.|Megfelelően működik, nem találtam hibát. |
|Bejelentkezés (jelszó) |2023.11.13|A program ellenőrizze, hogy az email címhez az adott jelszó van-e hozzá rendelve, ha nem hiba üzenetet dobjon. |A program megkeresi az adatbázisban a jelszót, ha nem szerepel hibabüzenetet dobjon.|Megfelelően működik, nem találtam hibát.|
